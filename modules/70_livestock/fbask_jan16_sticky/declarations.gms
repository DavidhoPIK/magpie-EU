...
positive variables
 ...
 v70_investment_immobile(j,kli)   Investment costs in immobile farm capital (mio USD05MER per yr)
;

equations
 q70_feed(i,kap,kall)             Regional feed demand
 q70_cost_prod_liv_labor(i)       Regional labor costs for livestock production
 q70_cost_prod_liv_capital(i)     Regional investment costs for livestock production
 q70_investment_immobile(j,kli)   Cellular immobile investments into farm capital  (mio USD05MER)
...
parameters
 ...
 p70_capital_need_immobile(t,i,kli)              Capital requirements per unit of output (USD05MER per ton DM)
 p70_capital_immobile(t,j,kli)                    Preexisting immobile capital stocks before investment (mio USD05MER)
 p70_prod_init(j,kli)                             Initial production of livestock products, See TODO
;
...
parameters
 ...
 ov70_investment_immobile(t,j,kli,type) Investment costs in immobile farm capital (mio USD05MER per yr)
 ...
 oq70_investment_immobile(t,j,kli,type) Cellular immobile investments into farm capital  (mio USD05MER)
