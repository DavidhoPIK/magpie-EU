...
*' Investment costs
q70_cost_prod_liv_capital(i2).. vm_cost_prod_livst(i2,"capital")=e=sum((cell(i2,j2),kli),v70_investment_immobile(j2,kli))
                                    *((1-s70_depreciation_rate)*
...
q70_investment_immobile(j2,kli).. v70_investment_immobile(j2,kli)
                                  =g=
                                 vm_prod(j2,kli)*sum(cell(i2,j2),sum(ct,p70_capital_need_immobile(ct,i2,kli)))-
                                 sum(ct,p70_capital_immobile(ct,j2,kli));
