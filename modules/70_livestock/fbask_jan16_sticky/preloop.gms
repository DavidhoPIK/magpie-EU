...
* disaggreagte 2005 production to get initial values for the livestock production
* TODO: Should initialize at 1995 and have a better disaggregation method
p70_prod_init(j,kli) = sum(cell(i,j),  f70_hist_prod_livst(i,kli,"dm")/sum(cellAlias(i,j2), 1) );