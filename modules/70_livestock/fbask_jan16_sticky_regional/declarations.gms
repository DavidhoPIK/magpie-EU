...
positive variables
 ...
 v70_investment_immobile(i,kli)   Investment costs in immobile farm capital (mio USD05MER per yr)
;
...
equations
 ...
 q70_investment_immobile(i,kli)   Cellular immobile investments into farm capital  (mio USD05MER)
...
parameters
 ...
 p70_capital_need_immobile(t,h,kli)              Capital requirements per unit of output (USD05MER per ton DM)
 p70_capital_immobile(t,i,kli)                    Preexisting immobile capital stocks before investment (mio USD05MER)
 p70_prod_init(i,kli)                             Initial production of livestock products, See TODO
;
...
parameters
 ...
 ov70_investment_immobile(t,i,kli,type) Investment costs in immobile farm capital (mio USD05MER per yr)
 ...
 oq70_investment_immobile(t,i,kli,type) Cellular immobile investments into farm capital  (mio USD05MER)
