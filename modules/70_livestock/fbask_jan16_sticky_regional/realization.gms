...
$Ifi "%phase%" == "sets" $include "./modules/70_livestock/fbask_jan16_sticky_regional/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/70_livestock/fbask_jan16_sticky_regional/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/70_livestock/fbask_jan16_sticky_regional/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/70_livestock/fbask_jan16_sticky_regional/equations.gms"
$Ifi "%phase%" == "preloop" $include "./modules/70_livestock/fbask_jan16_sticky_regional/preloop.gms"
$Ifi "%phase%" == "presolve" $include "./modules/70_livestock/fbask_jan16_sticky_regional/presolve.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/70_livestock/fbask_jan16_sticky_regional/postsolve.gms"
