...
*' Investment costs
q70_cost_prod_liv_capital(i2).. vm_cost_prod_livst(i2,"capital")=e=sum(kli,v70_investment_immobile(i2,kli))
...
q70_investment_immobile(i2,kli).. v70_investment_immobile(i2,kli)
                                  =g=
                                 vm_prod_reg(i2,kli)*sum(ct, sum(supreg(h2,i2), p70_capital_need_immobile(ct,h2,kli)) )-
                                 sum(ct,p70_capital_immobile(ct,i2,kli));
