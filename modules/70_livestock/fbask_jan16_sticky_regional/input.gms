...
$ondelim
$include "./modules/70_livestock/fbask_jan16_sticky_regional/input/f70_feed_baskets.cs3"
$offdelim;

table fm_feed_balanceflow(t_all,i,kap,kall) Balanceflow balance difference between estimated feed baskets and FAO (mio. tDM)
$ondelim
$include "./modules/70_livestock/fbask_jan16_sticky_regional/input/f70_feed_balanceflow.cs3"
$offdelim;

table f70_livestock_productivity(t_all,i,sys,feed_scen70) Productivity indicator for livestock production (t FM per animal)
$ondelim
$include "./modules/70_livestock/fbask_jan16_sticky_regional/input/f70_livestock_productivity.cs3"
$offdelim;

table f70_cost_regr(kap,cost_regr) Factor requirements livestock (USD04 per tDM (A) and USD (B))
$ondelim
$include "./modules/70_livestock/fbask_jan16_sticky_regional/input/f70_capit_liv_regr.csv"
$offdelim
;
...
/
$ondelim
$include "./modules/70_livestock/fbask_jan16_sticky_regional/input/f70_slaughter_feed_share.cs4"
$offdelim
/
;
...
/
$ondelim
$include "./modules/70_livestock/fbask_jan16_sticky_regional/input/f70_pyld_slope_reg.cs4"
$offdelim
/;
...
/
$ondelim
$include "./modules/70_livestock/fbask_jan16_sticky_regional/input/f70_cap_share_reg.csv"
$offdelim
/
;
...
$ondelim
$include "./modules/70_livestock/fbask_jan16_sticky_regional/input/f70_hist_cap_share.csv"
$offdelim
;
...
table f70_hist_prod_livst_1995(i,kli,attributes) Historical production quantity of livestock products (mio. t)
$ondelim
$include "./modules/70_livestock/fbask_jan16_sticky_regional/input/f70_hist_prod_livst_1995.cs3"
$offdelim
;
...
$ondelim
$include "./modules/70_livestock/fbask_jan16_sticky_regional/input/f70_feed_substitution_fader.csv"
$offdelim;
